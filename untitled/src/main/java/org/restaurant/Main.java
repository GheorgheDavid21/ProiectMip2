...
//    public static void alegereOptiuni(MenuProducts.Category cat, TreeMap<MenuProducts.Category, ArrayList<Optional<Product>>> products, Order order) {
...
//        }
//    }
//    private static TreeMap<MenuProducts.Category, ArrayList<Optional<Product>>> loadMenu() {
//        Gson gson = new Gson();
//        try (FileReader reader = new FileReader(PRODUCT_FILE)) {
//            JsonObject root = JsonParser.parseReader(reader).getAsJsonObject();
//            TreeMap<MenuProducts.Category, ArrayList<Optional<Product>>> menu = new TreeMap<>();
//
...
//                            p = new Food(name, price, category.toString(), weight); // assumes Food(String,double,int)
//                        } else if (obj.has("volume")) {
//                            int volume = obj.get("volume").getAsInt();
//                            p = new Drink(name, price, category.toString(), volume); // assumes Drink(String,double,int)
//                        } else {
...
//            for (MenuProducts.Category c : MenuProducts.Category.values()) {
...
//            return;
//        }
//        MenuProducts menu = new MenuProducts(loadMenu());
